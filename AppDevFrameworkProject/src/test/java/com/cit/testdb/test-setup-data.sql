...
insert into GENRE (GENRE_ID, GENRE_NAME) values (6, 'Drama');
insert into GENRE (GENRE_ID, GENRE_NAME) values (7, 'Mystery');
insert into GENRE (GENRE_ID, GENRE_NAME) values (8, 'Thriller');
insert into GENRE (GENRE_ID, GENRE_NAME) values (9, 'History');
insert into GENRE (GENRE_ID, GENRE_NAME) values (10, 'Sci-Fi');
insert into GENRE (GENRE_ID, GENRE_NAME) values (11, 'War');
...
values (1, '13 Assassins', 3.99, 2, 2010, '13_Assassins.jpg', '141 min', 'A group of assassins come together for a suicide mission to kill an evil lord.', 'Kôji Yakusho, Takayuki Yamada, Yûsuke Iseya', 'Takashi Miike', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (2, '2012', 3.99, 3, 2009, '2012.jpg', '158 min', 'Dr. Adrian Helmsley, part of a worldwide geophysical team investigating the effect on the earth of radiation from unprecedented solar storms, learns that the earth''s core is heating up. He warns U.S. President Thomas Wilson that the crust of the earth is becoming unstable and that without proper preparations for saving a fraction of the world''s population, the entire race is doomed. Meanwhile, writer Jackson Curtis stumbles on the same information. While the world''s leaders race to build "arks" to escape the impending cataclysm, Curtis struggles to find a way to save his family. Meanwhile, volcanic eruptions and earthquakes of unprecedented strength wreak havoc around the world.', 'John Cusack, Thandie Newton, Chiwetel Ejiofor', 'Roland Emmerich', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (3, 'Avatar', 5.99, 5, 2009, 'Avatar.jpg', '162 min', 'When his brother is killed in a robbery, paraplegic Marine Jake Sully decides to take his place in a mission on the distant world of Pandora. There he learns of greedy corporate figurehead Parker Selfridge''s intentions of driving off the native humanoid "Na''vi" in order to mine for the precious material scattered throughout their rich woodland. In exchange for the spinal surgery that will fix his legs, Jake gathers intel for the cooperating military unit spearheaded by gung-ho Colonel Quaritch, while simultaneously attempting to infiltrate the Na''vi people with the use of an "avatar" identity. While Jake begins to bond with the native tribe and quickly falls in love with the beautiful alien Neytiri, the restless Colonel moves forward with his ruthless extermination tactics, forcing the soldier to take a stand - and fight back in an epic battle for the fate of Pandora.', 'Sam Worthington, Zoe Saldana, Sigourney Weaver', 'James Cameron', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (4, 'Bad Teacher', 3.99, 2, 2011, 'Bad_Teacher.jpg', '92 min', 'A comedy centered around a foul-mouthed, junior high teacher who, after being dumped by her sugar daddy, begins to woo a colleague -- a move that pits her against a well-loved teacher.', 'Cameron Diaz, Jason Segel, Justin Timberlake', 'Jake Kasdan', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (5, 'Battle Los Angeles', 5.99, 4, 2011, 'Battle_Los_Angeles.jpg', '116 min', 'Los Angeles and other cities around the world are being bombarded by meteors that seem to be slowing down once they hit the earth''s atmosphere. The earth is suddenly being invaded by space aliens that have landed off the shore of LA, and who begin killing everybody along the beach. The military is ordered into action. Marine Staff Sergeant Nantz (Aaron Eckhart), who was about to retire, is reassigned to a new platoon. The platoon, flown by chopper to the forward operating base at Santa Monica Airport, is being led by a new 2nd Lt. Martinez (Ramon Rodriguez). They are sent on a mission to rescue some civilians who are trapped at the police station within alien territory. They only have 3 hours to complete their mission and get out before the Air Force bombs that zone.', 'Aaron Eckhart, Michelle Rodriguez, Bridget Moynahan', 'Jonathan Liebesman', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (6, 'Black Swan', 5.99, 3, 2010, 'Black_Swan.jpg', '108 min', 'Nina (Portman) is a ballerina in a New York City ballet company whose life, like all those in her profession, is completely consumed with dance. She lives with her obsessive former ballerina mother Erica (Hershey) who exerts a suffocating control over her. When artistic director Thomas Leroy (Cassel) decides to replace prima ballerina Beth MacIntyre (Ryder) for the opening production of their new season, Swan Lake, Nina is his first choice. But Nina has competition: a new dancer, Lily (Kunis), who impresses Leroy as well. Swan Lake requires a dancer who can play both the White Swan with innocence and grace, and the Black Swan, who represents guile and sensuality. Nina fits the White Swan role perfectly but Lily is the personification of the Black Swan. As the two young dancers expand their rivalry into a twisted friendship, Nina begins to get more in touch with her dark side - a recklessness that threatens to destroy her.', 'Natalie Portman, Mila Kunis, Vincent Cassel', 'Darren Aronofsky', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (7, 'Braveheart', 3.99, 4, 1995, 'Braveheart.jpg', '177 min', 'William Wallace is a Scottish rebel who leads an uprising against the cruel English ruler Edward the Longshanks, who wishes to inherit the crown of Scotland for himself. When he was a young boy, William Wallace''s father and brother, along with many others, lost their lives trying to free Scotland. Once he loses another of his loved ones, William Wallace begins his long quest to make Scotland free once and for all, along with the assistance of Robert the Bruce.', 'Mel Gibson, Sophie Marceau, Patrick McGoohan', 'Mel Gibson', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (8, 'Burlesque', 3.99, 3, 2010, 'Burlesque.jpg', '119 min', 'The Burlesque Lounge has its best days behind it. Tess, a retired dancer and owner of the venue, struggles to keep the aging theater alive, facing all kinds of financial and artistic challenges. With the Lounge''s troupe members becoming increasingly distracted by personal problems and a threat coming from a wealthy businessman''s quest to buy the spot from Tess, the good fortune seems to have abandoned the club altogether. Meanwhile, the life of Ali, a small-town girl from Iowa, is about to change dramatically. Hired by Tess as a waitress at the Lounge, Ali escapes a hollow past and quickly falls in love with the art of burlesque. Backed by newfound friends amongst the theater''s crew, she manages to fulfill her dreams of being on stage herself. Things take a dramatic turn though when Ali''s big voice makes her become the main attraction of the revue.', 'Cher, Christina Aguilera, Alan Cumming', 'Steve Antin', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (9, 'Cars 2', 5.99, 2, 2011, 'Cars_2.jpg', '112 min', 'Star race car Lightning McQueen and his pal Mater head overseas to compete in the World Grand Prix race. But the road to the championship becomes rocky as Mater gets caught up in an intriguing adventure of his own: international espionage.', 'Owen Wilson, Larry the Cable Guy, Michael Caine', 'N/A', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (10, 'Cars', 3.99, 3, 2006, 'Cars.jpg', '117 min', 'While traveling to California for the dispute of the final race of the Piston Cup against The King and Chick Hicks, the famous Lightning McQueen accidentally damages the road of the small town Radiator Springs and is sentenced to repair it. Lightning McQueen has to work hard and finds friendship and love in the simple locals, changing its values during his stay in the small town and becoming a true winner.', 'Owen Wilson, Bonnie Hunt, Paul Newman', 'N/A', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
values (11, 'Centurion', 5.99, 4, 2010, 'Centurion.jpg', '97 min', 'Britain, A.D. 117. Quintus Dias, the sole survivor of a Pictish raid on a Roman frontier fort, marches north with General Virilus'' legendary Ninth Legion, under orders to wipe the Picts from the face of the Earth and destroy their leader, Gorlacon.', 'Michael Fassbender, Dominic West, Olga Kurylenko', 'Neil Marshall', '', '');
insert into MOVIE (MOVIE_ID, TITLE, PRICE, RATING, YEAR, POSTER_FILENAME, DISPLAY_RUNTIME, SUMMARY, ACTORS_DISPLAY, DIRECTORS_DISPLAY, PRODUCERS_DISPLAY, STUDIO_DISPLAY)
...
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (2,8);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (2,10);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (3,1);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (3,2);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (3,10);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (4,4);
...
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (9,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (9,5);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (9,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (10,2);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (10,3);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (10,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (10,5);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (11,1);
...
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (13,2);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (13,3);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (13,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (13,10);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (14,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (14,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (15,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (15,8);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (16,1);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (16,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (16,8);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (17,3);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (17,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (17,5);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (18,4);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (18,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (19,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (19,9);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (19,11);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (20,1);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (20,2);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (20,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (21,5);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (21,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (22,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (22,8);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (23,1);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (23,8);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (23,10);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (24,2);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (24,6);
insert into MOVIE_GENRE_LINK (MOVIE_ID, GENRE_ID) values (24,11);
